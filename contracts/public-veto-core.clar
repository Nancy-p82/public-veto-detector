;; public-veto-core
;; 
;; This contract serves as the central hub for the Public Veto Protocol, handling:
;; - Community member registration and verification
;; - Proposal submission and tracking
;; - Decentralized voting mechanisms
;; - Transparent decision-making processes
;; - Reputation and accountability tracking
...
(define-constant ERR-INVALID-VOTE-TYPE (err u106))
(define-constant ERR-PROPOSAL-CLOSED (err u107))
(define-constant ERR-VETO-NOT-ALLOWED (err u108))
(define-constant ERR-REPUTATION-UPDATE-FAILED (err u109))
(define-constant ERR-INVALID-CREDENTIALS (err u110))
